...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/17 15:30:35 by jgounand          #+#    #+#             */
/*   Updated: 2019/09/17 15:31:42 by jgounand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_n_value(t_symbol *sym, short type_cpu)
{
	...
	else
	{
		...
		ft_memcpy(string + ft_strlen(string) - ft_strlen(n_value_string) + 1,
				n_value_string, ft_strlen(n_value_string));
		free(n_value_string);
	}
	if (type_cpu == 32)
		ft_putstr(string + 8);
